    ...
    <MDBRow>
      <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
        ...
        <div className="d-flex flex-row align-items-center mb-4 ">
          ...
          <MDBInput label='Your Name' id='form1' type='text' onChange={e => setusername(e.target.value)} className='w-100'/>
        </div>
        ...
        <MDBBtn onClick={()=>{  if(username=="pubudu"&&password=="123"){alert("this.username "+ username ); }              navigate("/Admindataenterpage")}} className='mb-4' size='lg' >Login</MDBBtn>
